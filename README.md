# Frontend Mentor - componente do cartão de visualização NFT

![Visualização do design para o desafio de codificação do componente do cartão de visualização NFT](./design/desktop-preview.jpg)
